      ...
      <div className="flex flex-col-reverse md:flex-row my-10">
        <div className="md:w-1/3 rounded-md bg-white mr-3">
          ...
          <div className="shadow-lg px-3 my-10">
            <h1 className="font-semibold md:text-3xl text-xl my-5 text-primary">
              Popular Posts
            </h1>
        ...
        <div className="md:w-2/3 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 mr-2">
          {currentItems.map((data) => (
            <div
              key={data.btn}
              className="border mx-auto p-4 hover:shadow-lg  duration-300"
            >
              <img src={data.img} className="w-full lg:w-[400px] h-[230px]" />
              <h1 className="text-xl text-primary font-semibold cursor-pointer my-3 ">
                {data.heading}
              </h1>
              ...
              <div className="mt-3 flex justify-between">
                ...
                <p className="flex items-center  font-semibold">
                  <AiTwotoneDislike className="mr-1 text-primary" />{" "}
                  <span>6</span>
                </p>
              </div>
              ...
              <div className="flex justify-between mt-3 border-t p-2 text-gray-800">
                ...
                <Link to="/blog-details">
                  <h1 className="text-indigo-600 hover:text-primary my-auto cursor-pointer">
                    {data.btn}
                  </h1>
                </Link>
              </div>
