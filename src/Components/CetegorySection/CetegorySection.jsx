        ...
        <div className='mt-10 max-w-screen-xl mx-auto p-3'>
            <h1 className='text-3xl font-semibold text-primary my-10'>Our Cetegory</h1>
                <ul className='flex justify-betwee items-center w-full'>
                    <li className={`${living && "border-b-4 border-primary"} font-semibold md:text-l text-sm text-primary cursor-pointer`} onClick={handleLiving}>LIVING ROOM</li>
                    <li className={`${bed && "border-b-4 border-primary"} font-semibold md:text-l text-sm text-primary cursor-pointer ml-10`} onClick={handleBed}>BED ROOM</li>
                    <li className={`${dining && "border-b-4 border-primary"} font-semibold md:text-l text-sm text-primary cursor-pointer ml-10`} onClick={handleDining}>DINING ROOM</li>
                    <li className={`${light && "border-b-4 border-primary"} font-semibold md:text-l text-sm text-primary cursor-pointer ml-10`} onClick={handleLight}>LIGHT</li>
                </ul>

            
            {
                living && <CetegorySection1 
                heading="Living room" 
                img1={sofa4} 
                img2={sofa3} 
                img3={sofa2} 
